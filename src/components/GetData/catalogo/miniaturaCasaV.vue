<template>
  <div class="container mx-auto">
    <router-link :to="{name: 'infoCasaCd', params:{idCasa: idCasa, idEst: idEstado, idCd: idCiudad, tipo: 'Venta' }}">
...
export default {
  ...
  created () {
    ...
    firebase.firestore().collection('Ubicaciones').doc(this.idEstado).collection('Ciudades').doc(this.idCiudad).collection('Venta').doc(this.idCasa).get().then(casa => {
    ...
    this.rutaFoto = `Ubicaciones/${this.idEstado}/${this.idCiudad}/Casas/Venta/${this.idCasa}/portada/portada.jpg`
