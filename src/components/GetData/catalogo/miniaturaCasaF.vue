<template>
  <div class="container mx-auto">
    <router-link :to="{name: 'infoCasa', params:{idCasa: idCasa, idEst: idEstado, idCd: idCiudad, enFraccionamiento: 'si', idFrc: idFracc }}">
...
export default {
  ...
  created () {
    ...
    firebase.firestore().collection('Ubicaciones').doc(this.idEstado).collection('Ciudades').doc(this.idCiudad).collection('Fraccionamientos').doc(this.idFracc).collection('casas').doc(this.idCasa).get().then(casa => {
    ...
    this.rutaFoto = `Ubicaciones/${this.idEstado}/${this.idCiudad}/Fraccionamientos/${this.idFracc}/${this.idCasa}/portada/portada.jpg`
